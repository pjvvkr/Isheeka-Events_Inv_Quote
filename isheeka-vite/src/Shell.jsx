...
export default function Shell() {
  ...
  const navigate = useCallback((page, opts = {}) => {
    const o = opts || {};
    const rest = {}; ['eventId', 'leadId', 'invoiceId', 'quotId', 'clientId', 'vendorId', 'expenseId', 'rfqId', 'prefill', 'mode', 'referenceEvent', 'referenceData'].forEach((k) => { if (o[k] !== undefined && o[k] !== null) rest[k] = o[k]; });
